...
namespace API
{
    public class Startup
    {
        ...
        { 
            ...
            services.AddTransient<ISoVanBanBusiness, SoVanBanBusiness>();
            services.AddTransient<ISoVanBanRepository, SoVanBanRepository>();
            services.AddTransient<ILoaiVanBanBusiness, LoaiVanBanBusiness>();
            services.AddTransient<ILoaiVanBanRepository, LoaiVanBanRepository>();
            services.AddTransient<IWorkBusiness, WorkBusiness>();
